...
<body data-ng-controller="RootCtrl"><!--the root controller is initialized here-->
  ...
  <ng-include ng-controller="IotUrlCtrl" src="currUrl"></ng-include><!--the routing controller is initialized here-->
  ...
  <script src="/min-libs/angular-1.2.7/angular.js"></script><!--AngularJS, version 1.2.7-->
  <script src="/min-libs/angular-1.2.7/angular-route.min.js"></script><!--AngularJS's routing page-->
  ...
  <script src="modules/main/js/url.min.js"></script><!--the routing module for the site-->
